...
export function VerifyEmail({ setView }: { setView: (v: View) => void }) {
  ...
  return (
    <AuthLayout title="Email Verification" subtitle="Confirm your email address">
      {state === "loading" && (
      ...
      {state === "success" && (
        <div className="space-y-4 text-center">
          ...
          <Btn variant="primary" size="lg" className="w-full justify-center" onClick={() => setView("buyer-login")}>
            Sign In
          </Btn>
        </div>
      )}

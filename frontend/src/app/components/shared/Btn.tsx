...
export function Btn({ children, variant = "primary", size = "md", onClick, className = "", disabled = false, type, ...rest }: {
...
} & Omit<ButtonHTMLAttributes<HTMLButtonElement>, "onClick" | "disabled" | "type" | "className" | "children">) {
